...
import { IconCameraBolt, IconHome2, IconTargetArrow, IconVideoPlus } from "@tabler/icons-react";
    ...
    >
        ...
        <Group justify="space-between" pr="lg">
          <Group justify="flex-start" align="center" px="sm" py={10}>
            <Burger
              ...
              size="sm"
            />
            <Image src="/MPL-PORD.png" alt="Logo MPL-PORD" height={40} fit="contain" />
          </Group>
      ...
      <AppShell.Navbar p="md">
        <Stack gap={5}>
          ...
          <NavLink
            label="Stream"
            active={router.pathname === "/stream"}
            component={Link}
            href="/stream"
            leftSection={<IconCameraBolt size={20} stroke={1.5} />}
          />
        </Stack>
      </AppShell.Navbar>
