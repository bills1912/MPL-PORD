...
const RES_TO_MODEL: [number[], string][] = [
  ...
  [[640, 640], "palm-oil-detection-collaborative.onnx"],
  [
    [640, 640],
    "palm-oil-detection-collaborative.with_runtime_opt.optimized.onnx",
  ],
];
...
const Yolo = (props: any) => {
  ...
  const postprocess = async (
    ...
    if (modelName === "palm-oil-detection-collaborative.with_runtime_opt.optimized.onnx" || modelName === "palm-oil-detection-collaborative.onnx") {
      console.log(tensor);
